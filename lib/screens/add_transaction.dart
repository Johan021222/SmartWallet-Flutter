...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  ...
  // 6. Método para guardar la transacción y volver a la pantalla anterior
  void _guardarTransaccion() {
    ...
    // Crear la nueva transacción con los datos ingresados
    final montoFinal = _tipoTransaccion == 'Ingreso'
        ? monto.abs()
        : -monto.abs();
    final icono = _tipoTransaccion == 'Ingreso'
        ? Icons.attach_money
        : Icons.shopping_cart;
    ...
    // Retornar a la pantalla anterior con la nueva transacción
